...
**Slack notification** — a real alert delivered by the pipeline:

![Slack alert](docs/slack-alert-screenshot.png)

**Autonomous PR** — a real pull request opened by the action layer (see it live: [PR #2](https://github.com/Laharyy/roottrace-demo-target/pull/2)):

![GitHub PR](docs/github-pr-screenshot.png)

**How to trigger an alert yourself** (local setup):

![Flowchart](docs/slack-alert-flowchart.jpg)
